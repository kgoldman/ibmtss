...
/*            $Id: CpriHash.c 815 2016-11-16 23:16:48Z kgoldman $		*/
/*										*/
...
/* #   define UNREFERENCED_PARAMETER(a)   (a) kgold = for gcc */
	     ...
	     )
{
    ...
    pAssert((unsigned int)ctxt->digest->ctx_size < sizeof(ALIGNED_HASH_STATE));
...
// the first implemented hash and and index of 2 w ill return the last. All other index values will
// return TPM_ALG_NULL.
		      ...
		      )
{
    ...
    pAssert(sizeof(OSSL_HASH_STATE) <= sizeof(in->state));
...
_cpri__ImportExportHashState(
			     CPRI_HASH_STATE     *osslFmt,       // IN/OUT: the hash state formated
								 // for use by openSSL
