...
extern "C" {
    ...
    LIB_EXPORT TPM_RC
    TPMI_DH_PARENT_Unmarshal(TPMI_DH_PARENT *target, BYTE **buffer, uint32_t *size, BOOL allowNull);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_HA_Unmarshal(TPMU_HA *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMS_TAGGED_POLICY_Unmarshal(TPMS_TAGGED_POLICY *target, BYTE **buffer, uint32_t *size);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPML_TAGGED_POLICY_Unmarshal(TPML_TAGGED_POLICY *target, BYTE **buffer, uint32_t *size);
    LIB_EXPORT TPM_RC
    TPMU_CAPABILITIES_Unmarshal(TPMU_CAPABILITIES *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_ATTEST_Unmarshal(TPMU_ATTEST *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_SYM_KEY_BITS_Unmarshal(TPMU_SYM_KEY_BITS *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    TPMU_SYM_MODE_Unmarshal(TPMU_SYM_MODE *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPM2B_LABEL_Unmarshal(TPM2B_LABEL *target, BYTE **buffer, uint32_t *size);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_SCHEME_KEYEDHASH_Unmarshal(TPMU_SCHEME_KEYEDHASH *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_SIG_SCHEME_Unmarshal(TPMU_SIG_SCHEME *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_KDF_SCHEME_Unmarshal(TPMU_KDF_SCHEME *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_ASYM_SCHEME_Unmarshal(TPMU_ASYM_SCHEME *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_SIGNATURE_Unmarshal(TPMU_SIGNATURE *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_PUBLIC_ID_Unmarshal(TPMU_PUBLIC_ID *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_PUBLIC_PARMS_Unmarshal(TPMU_PUBLIC_PARMS *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
    ...
    LIB_EXPORT TPM_RC
    TPMU_SENSITIVE_COMPOSITE_Unmarshal(TPMU_SENSITIVE_COMPOSITE *target, BYTE **buffer, uint32_t *size, UINT32 selector);
    LIB_EXPORT TPM_RC
