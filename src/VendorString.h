...
/*            $Id: VendorString.h 141 2015-03-16 17:08:34Z kgoldman $		*/
/*										*/
...
// Define up to 4, 4-byte values. The values must each be 4 bytes long and the last value used may
// contain trailing zeros. These values define the response for TPM_PT_VENDOR_STRING_(1-4) in
// TPM2_GetCapability(). The following line should be un-commented and a vendor specific string
// should be provided here. The vendor strings 2-4 may also be defined as appropriately.
